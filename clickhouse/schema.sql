-- from https://github.com/umami-software/umami/blob/master/db/clickhouse/schema.sql
...
CREATE MATERIALIZED VIEW IF NOT EXISTS umami.website_event_stats_hourly_mv
